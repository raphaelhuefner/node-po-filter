...
PoFileEntry.prototype.hasNoCommentsYet = function () {
...
PoFileEntry.prototype.isAcceptingBlankline = function () {
    return (! this.hasSeenBlankline) && this.hasNoCommentsYet() && this.hasNoFieldsYet();
};
...
PoFileEntry.prototype.acceptToken = function (token) {
    switch (token.type) {
        case 'blankline':
            return this.acceptBlankline(token.value);
        case 'comment':
...
PoFileEntry.prototype.acceptBlankline = function (blankline) {
    if (this.isAcceptingBlankline()) {
        this.hasSeenBlankline = true;
        return true;
    }
    return false;
};
...
PoFileEntry.prototype.getFieldValue = function (fieldname) {
  if (this.hasFieldWithStrings(fieldname)) {
    var output = ''
      , strings = this.fields[fieldname].strings;
